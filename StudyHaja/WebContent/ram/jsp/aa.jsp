...
<body>
   ...
   <hr border-width="3">
   <div class="first">
      <button id="btnList" onclick="document.location.href='roomList.do?pageNum=${pageNum}'">목록</button>&nbsp;&nbsp;&nbsp;
      <button id="btnModify" onclick="document.location.href='cafeupdateForm.do?num=${list.num}&pageNum=${pageNum}'">수정하기</button>   
